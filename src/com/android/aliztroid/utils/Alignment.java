...
public class Alignment {
	...
	public static float[] getTextureCordinates(Sprite sprite) 
	{
		...
		float vertices[] = {
				  ...
				  // 0, Top Left
				(float)((c-1)/sprite.columns) ,(float) ((r-1)/sprite.rows),   // 1, Bottom Left
				(float) ((c-1)/sprite.columns) ,(float) (r/sprite.rows),  // 2, Bottom Right
				(float) ( c/sprite.columns),(float)(r/sprite.rows), // 3, Top Right
				(float)(c/sprite.columns) ,(float) ((r-1)/sprite.rows)
		};
		return vertices;
